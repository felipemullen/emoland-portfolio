...
export function Sidebar() {
    ...
    return (
        <div className="fixed group/bar top-0 left-0 h-screen bg-white/35 border-r border-neutral-200 hover:border-violet-300 z-50">
            ...
            <ul className="px-3 text-slate-600">
                {links.map((link, index) => (
                    <li key={index} className="group/link flex items-center">
                        <Link href={link.href} className="flex items-center py-2 group-hover/link:text-violet-700">
                            ...
                            <span className="max-w-0 rounded group-hover/link:bg-white group-hover/link:ml-2 group-hover/link:pr-2 overflow-hidden group-hover/link:max-w-screen-xl origin-left duration-300 group-hover/bar:duration-1000 ease-in-out transition-[max-width]">
